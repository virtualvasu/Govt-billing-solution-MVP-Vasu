...
import { IonAlert, IonContent, IonHeader, IonPage, IonTitle, IonToast, IonToolbar } from "@ionic/react";
...
const FilesPage: React.FC = () => {
  ...
  const { selectedFile, resetToDefaults, billType, store, updateSelectedFile, updateBillType } =
    useInvoice();
